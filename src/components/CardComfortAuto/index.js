...
import styles from "./CardComfortAuto.module.scss";


function CardComfortAuto({ categoryAuto, imageUrlСar, carName, carPrice,
    ...
    return (
        <Link className={styles.cardLink} to="/AutoInfo">
            <div className={styles.cardLink}>
                <div className={styles.card}>
                    <div className={styles.card__leftSide}>
                        ...
                        <div className={styles.leftSide__carImg}>
...
export default CardComfortAuto;